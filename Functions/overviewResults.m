...
EasyPlot.exportFigure(fig, fullfile(user_settings.output_folder, 'Figures/Overview'));
EasyPlot.exportFigure(fig, fullfile(user_settings.output_folder, 'Figures/Overview'), 'type', 'pdf');
